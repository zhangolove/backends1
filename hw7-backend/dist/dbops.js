...
exports.updateProfile = exports.getProfile = exports.addComment = exports.updateComment = exports._updateArticle = exports.updateArticle = exports.findArticle = exports.saveArticle = exports.saveProfile = exports.updatePassword = exports.saveUser = exports.checkUserExists = exports.findUser = undefined;
...
var findArticle = exports.findArticle = function findArticle(query, callback) {
	_model.Article.find(query, { '__v': 0 }, function (err, items) {
		if (err || items.length === 0) {
			//if no match, return all articles
			console.log('nomatch');
			console.log(items);
			_model.Article.find().exec(function (err, items) {
				callback(items);
			});
		} else {
